...
from base_classes import NodeEnvironment, Node, NodeType, generate_node_types
...
globalstore.set("LENGTH", " about 300 words ")
...
output_file_path = os.path.abspath("poetry_01.txt")
