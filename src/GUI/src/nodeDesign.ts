...
export const DISPLAY_STATE_WIDTH = 14;
export const DISPLAY_STATE_HEIGHT = 32;
...
export const BYPASS_BUTTON_WIDTH = 16;
export const BYPASS_BUTTON_HEIGHT = 32;
...
export const BYPASS_BUTTON_FONT_SIZE = 16;
...
export const TEXT_AREA_RIGHT = BYPASS_BUTTON_RIGHT + BYPASS_BUTTON_WIDTH + TEXT_SPACING_FROM_INDICATOR;
