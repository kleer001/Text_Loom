...
dark_metal_theme = Theme(
    name="dark_metal",
    dark=False,
    
    # Core colors
    background="#222222"    # Medium contrast bg",
    foreground="#D3D3D3"         # Low contrast text",
    primary="#708090"       # Low contrast border",
    ...
    variables={
        "text-muted": "#D3D3D3"         # Low contrast text",
        ...
        "background-help": "#222222"       # Medium contrast bg",
        ...
        "input-border": "#708090"     # Low contrast border",
